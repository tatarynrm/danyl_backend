...
INSERT INTO controller_logs
  (device_code,log_date,event_code,log_value)
VALUES 
  ($1,$2,$3,$4);
`
      await client.query("BEGIN"); // Початок транзакції
